        ...
        <div className="mb-12">
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 border border-purple-500">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="bg-white text-purple-600 hover:bg-purple-50 px-6 py-3 rounded-lg font-semibold transition-colors flex items-center">
                Começar a Ler
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categoryFilteredGuides.map((guide, index) => (
            ...
            >
              ...
              <button className="w-full bg-transparent border border-purple-600 text-purple-400 hover:bg-purple-600 hover:text-white py-2 rounded-lg font-medium transition-colors flex items-center justify-center">
                Ler Guia
                <ArrowRight className="ml-2 h-4 w-4" />
              </button>
            </article>
